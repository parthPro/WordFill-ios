...
public class PickerController_Base: UIViewController {
    ...
    public override func loadView() {
        ...
        pickerControl.layer.cornerRadius = 10
        pickerControl.layer.masksToBounds = true
        view.addConstraint(NSLayoutConstraint(item: pickerControl, attribute: .leading, relatedBy: .equal, toItem: view, attribute: .leading, multiplier: 1, constant: 10))
        view.addConstraint(NSLayoutConstraint(item: pickerControl, attribute: .trailing, relatedBy: .equal, toItem: view, attribute: .trailing, multiplier: 1, constant: -10))
